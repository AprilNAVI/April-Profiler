...
void FOpenGLDynamicRHI::RHIBeginFrame()
{
	...
	AprilGPUProfilingData.BeginFrame(this);
	UE_LOG(LogTemp,Log,TEXT("FOpenGLDynamicRHI::RHIBeginFrame()"));
...
void FOpenGLDynamicRHI::RHIEndFrame()
{
	...
	AprilGPUProfilingData.EndFrame();
	UE_LOG(LogTemp,Log,TEXT("FOpenGLDynamicRHI::RHIEndFrame()"));
}
